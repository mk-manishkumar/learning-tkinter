...
btn_add = Button(root, text='+', bg='#00a65a', fg='white',
...
btn_subtract = Button(root, text='-', bg='#00a65a',
                      fg='white', width=5, height=2, command=lambda: get_operator('-'))
...
btn_multiply = Button(root, text='*', bg='#00a65a',
                      fg='white', width=5, height=2, command=lambda: get_operator('*'))
btn_multiply.grid(row=3, column=3)
btn_multiply.config(font=('verdana', 14))

btn_clear = Button(root, text='C', bg='#00a65a', fg='white',
...
btn_divide = Button(root, text='/', bg='#00a65a',
                    fg='white', width=5, height=2, command=lambda: get_operator('/'))
